...
const outputPath = join(tmpdir(), "mcpi-browser-smoke.js");
const agentTreeshakeOutputPath = join(tmpdir(), "mcpi-agent-treeshake-smoke.js");
const errorLogPath = join(tmpdir(), "mcpi-browser-smoke-errors.log");
