...
import { type AutocompleteProvider, CombinedAutocompleteProvider } from "@sammorrowdrums/mcpi-tui";
...
describe("InteractiveMode.showLoadedResources", () => {
	...
	function createExtensionFixtures(): ExtensionFixture[] {
		return [
			{
				path: "/tmp/project/.mcpi/extensions/answer.ts",
				sourceInfo: createSourceInfo("/tmp/project/.mcpi/extensions/answer.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.mcpi/extensions",
				}),
			},
			{
				path: "/tmp/project/.mcpi/extensions/local-index/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.mcpi/extensions/local-index/index.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.mcpi/extensions",
			...
			{
				path: "/tmp/project/.mcpi/npm/node_modules/pi-markdown-preview/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.mcpi/npm/node_modules/pi-markdown-preview/extensions/index.ts",
					{
						source: "npm:pi-markdown-preview",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.mcpi/npm/node_modules/pi-markdown-preview",
					},
				),
			},
			{
				path: "/tmp/project/.mcpi/npm/node_modules/@scope/pi-scoped/extensions/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.mcpi/npm/node_modules/@scope/pi-scoped/extensions/index.ts", {
					source: "npm:@scope/pi-scoped",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.mcpi/npm/node_modules/@scope/pi-scoped",
				}),
			},
			{
				path: "/tmp/project/.mcpi/git/github.com/HazAT/pi-interactive-subagents/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.mcpi/git/github.com/HazAT/pi-interactive-subagents/extensions/index.ts",
					{
						source: "git:github.com/HazAT/pi-interactive-subagents",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.mcpi/git/github.com/HazAT/pi-interactive-subagents",
					},
				),
			},
			{
				path: "/tmp/project/.mcpi/git/github.com/HazAT/pi-interactive-subagents/extensions/subagents/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.mcpi/git/github.com/HazAT/pi-interactive-subagents/extensions/subagents/index.ts",
					{
						source: "git:github.com/HazAT/pi-interactive-subagents",
						scope: "project",
						origin: "package",
...
"[Extensions]
  pi-markdown-preview"`);
	...
	test("labels npm sibling extensions relative to the declaring package", () => {
		const extensions: ExtensionFixture[] = [
			{
				path: "/tmp/project/.mcpi/npm/node_modules/primary-package/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.mcpi/npm/node_modules/primary-package/index.ts", {
					source: "npm:primary-package",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.mcpi/npm/node_modules/primary-package",
				}),
			},
			{
				path: "/tmp/project/.mcpi/npm/node_modules/sibling-package/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.mcpi/npm/node_modules/sibling-package/index.ts", {
					source: "npm:primary-package",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.mcpi/npm/node_modules/primary-package",
...
"[Extensions]
  primary-package, primary-package:../sibling-package"`);
	...
	test("labels Windows npm sibling extensions relative to the declaring package", () => {
		const primaryPath = "C:\\Users\\me\\AppData\\Local\\mcpi\\npm\\node_modules\\primary-package\\index.ts";
		const siblingPath = "C:\\Users\\me\\AppData\\Local\\mcpi\\npm\\node_modules\\sibling-package\\index.ts";
		const baseDir = "C:\\Users\\me\\AppData\\Local\\mcpi\\npm\\node_modules\\primary-package";
		const extensions: ExtensionFixture[] = [
			{
				path: primaryPath,
...
"[Extensions]
  project
    /tmp/project/.mcpi/extensions/answer.ts
    /tmp/project/.mcpi/extensions/local-index
  ...
  path
	...
	test("shows context paths relative to cwd while preserving full external paths", () => {
		const home = homedir();
		const cwd = path.join(home, "Development", "mcpi");
		const fakeThis = createShowLoadedResourcesThis({
			quietStartup: false,
			cwd,
			contextFiles: [
				{ path: path.join(home, ".config", "mcpi", "AGENTS.md") },
		...
		expect(output).toContain("~/.config/mcpi/AGENTS.md, AGENTS.md");
	...
	test("shows system prompt context paths before project context files", () => {
		...
		const fakeThis = createShowLoadedResourcesThis({
			quietStartup: false,
			cwd,
			systemPromptSource: { path: path.join(cwd, ".mcpi", "SYSTEM.md") },
			appendSystemPromptSources: [{ path: path.join(cwd, ".mcpi", "APPEND_SYSTEM.md") }],
		...
		const output = renderAll(fakeThis.loadedResourcesContainer).replace(/\\/g, "/");
		expect(output).toContain("[Context]");
		expect(output).toContain(".mcpi/SYSTEM.md, .mcpi/APPEND_SYSTEM.md, AGENTS.md");
	});
	...
	test("shows full context paths when expanded", () => {
		...
		const output = renderAll(fakeThis.loadedResourcesContainer).replace(/\\/g, "/");
		expect(output).toContain("[Context]");
		expect(output).toContain("~/.config/mcpi/AGENTS.md");
		expect(output).toContain("~/Development/mcpi/AGENTS.md");
		expect(output).not.toContain("~/.config/mcpi/AGENTS.md, AGENTS.md");
	});
