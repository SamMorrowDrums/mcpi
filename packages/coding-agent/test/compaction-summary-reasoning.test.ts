...
import type { AssistantMessage, Model } from "@sammorrowdrums/mcpi-ai";
...
vi.mock("@sammorrowdrums/mcpi-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@sammorrowdrums/mcpi-ai/compat")>();
	return {
		...actual,
