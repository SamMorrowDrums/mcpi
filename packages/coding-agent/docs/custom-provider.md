...
- `stopReason === "error"`
- `errorMessage` matches one of pi's known overflow patterns (see [`packages/ai/src/utils/overflow.ts`](https://github.com/SamMorrowDrums/mcpi/blob/main/packages/ai/src/utils/overflow.ts))
