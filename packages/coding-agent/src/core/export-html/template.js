    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="mcpi-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="mcpi-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'mcpi-share:v1:sidebar-width';
