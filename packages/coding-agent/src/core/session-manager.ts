...
import { type ImageContent, type Message, type TextContent, type Usage, uuidv7 } from "@sammorrowdrums/mcpi-ai";
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	usage?: Usage;
	/** True if generated by an extension, undefined/false if mcpi-generated (backward compatible) */
	fromHook?: boolean;
}
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	usage?: Usage;
	/** True if generated by an extension, false if mcpi-generated */
	fromHook?: boolean;
}
