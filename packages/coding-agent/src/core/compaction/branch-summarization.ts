...
import type { AgentMessage, StreamFn } from "@sammorrowdrums/mcpi-agent-core";
import type { RetryCallbacks, RetryPolicy } from "@sammorrowdrums/mcpi-ai";
import { contentText } from "@sammorrowdrums/mcpi-ai";
import type { Model, SimpleStreamOptions, Usage } from "@sammorrowdrums/mcpi-ai/compat";
import {
	convertToLlm,
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from mcpi-generated summaries (fromHook !== true), not extension-generated ones
