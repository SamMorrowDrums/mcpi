...
import * as _bundledPiAgentCore from "@sammorrowdrums/mcpi-agent-core";
import type { Provider } from "@sammorrowdrums/mcpi-ai";
import * as _bundledPiAiCompat from "@sammorrowdrums/mcpi-ai/compat";
import * as _bundledPiAiOauth from "@sammorrowdrums/mcpi-ai/oauth";
import * as _bundledPiAiProviders from "@sammorrowdrums/mcpi-ai/providers/all";
import type { KeyId } from "@sammorrowdrums/mcpi-tui";
import * as _bundledPiTui from "@sammorrowdrums/mcpi-tui";
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@sammorrowdrums/mcpi-ai/compat": _bundledPiAiCompat,
...
function getAliases(): Record<string, string> {
	...
	const piAiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@sammorrowdrums/mcpi-ai/oauth");
	const piAiProvidersEntry = resolveWorkspaceOrImport(
		"ai/dist/providers/all.js",
		"@sammorrowdrums/mcpi-ai/providers/all",
	);

	_aliases = {
		"@sammorrowdrums/mcpi": piCodingAgentEntry,
		"@sammorrowdrums/mcpi-agent-core": piAgentCoreEntry,
		"@sammorrowdrums/mcpi-tui": piTuiEntry,
		"@sammorrowdrums/mcpi-ai/providers/all": piAiProvidersEntry,
