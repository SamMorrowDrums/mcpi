 ...
 * working indicator shown while mcpi is streaming a response.
 *
 * Usage:
 *   mcpi --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore mcpi's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@sammorrowdrums/mcpi";
