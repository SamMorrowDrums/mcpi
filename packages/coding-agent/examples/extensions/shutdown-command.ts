 ...
 * Demonstrates how extensions can use ctx.shutdown() to exit mcpi cleanly.
 */
...
export default function (pi: ExtensionAPI) {
	// Register a /quit command that cleanly exits mcpi
	pi.registerCommand("quit", {
		description: "Exit mcpi cleanly",
	...
	pi.registerTool({
		...
		description: "Complete a task and exit mcpi",
	...
	pi.registerTool({
		...
		description: "Deploy the application and exit mcpi",
		parameters: Type.Object({
