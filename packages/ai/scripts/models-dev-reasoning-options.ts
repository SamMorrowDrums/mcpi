...
/**
 * Converts models.dev verified effort values into mcpi's selectable thinking levels.
 * Values without an mcpi equivalent (`default` and JSON `null`) are intentionally
 * omitted.
 */
