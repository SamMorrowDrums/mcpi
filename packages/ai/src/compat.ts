 ...
 *
 * Existing apps switch imports from "@sammorrowdrums/mcpi-ai" to
 * "@sammorrowdrums/mcpi-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@sammorrowdrums/mcpi-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@sammorrowdrums/mcpi-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@sammorrowdrums/mcpi-ai/providers/all" or `Models.getProviders()`. */
