...
describe("resource formatting helpers", () => {
	it("formats skill invocations with additional instructions", () => {
		const skill = {
			...
			filePath: "/project/.mcpi/skills/inspect/SKILL.md",
		};

		expect(formatSkillInvocation(skill, "Check errors.")).toBe(
			'<skill name="inspect" location="/project/.mcpi/skills/inspect/SKILL.md">\nReferences are relative to /project/.mcpi/skills/inspect.\n\nUse inspection tools.\n</skill>\n\nCheck errors.',
		);
	});
