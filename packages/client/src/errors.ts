import type { JsonValue, ProtocolError, ProtocolErrorCode } from "@sammorrowdrums/mcpi-protocol";
...
export class PiDisconnectedError extends Error {
	constructor(message = "mcpi client is disconnected") {
		super(message);
