...
For non-Windows cross-builds, or for custom Windows toolchains, set `MCPI_TUI_WIN32_TOOLCHAIN=mingw` and provide MinGW-compatible compilers:

```sh
MCPI_TUI_WIN32_TOOLCHAIN=mingw \
