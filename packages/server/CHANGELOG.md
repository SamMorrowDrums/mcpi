...
- Renamed the public npm package from `@earendil-works/pi-server` to `@sammorrowdrums/mcpi-server`. The new package explicitly publishes to the public npm registry and requires Node.js 22.19 or newer.
