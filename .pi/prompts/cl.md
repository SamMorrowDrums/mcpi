...
Attribution:
- Internal: `Fixed foo ([#123](https://github.com/SamMorrowDrums/mcpi/issues/123))`
- External: `Added bar ([#456](https://github.com/SamMorrowDrums/mcpi/pull/456) by [@user](https://github.com/user))`
